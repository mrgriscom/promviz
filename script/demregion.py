...
S3_SERVER = 'http://localhost/dem3'
TMP_DEM = '/tmp/promviz/dem'
TMP_NET = '/tmp/promviz/pnet'
...
if __name__ == "__main__":
    ...
    for cell in cells(poly, res):
        ...
        path = os.path.join(TMP_DEM, '%s.hgt' % tag)
