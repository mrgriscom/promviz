...
public class TopologyNetworkPipeline {
  ...
  static String test = "36.25,22.5 38.6,22.5 38.6,25.8 36.25,25.8";
  ...
  static PCollection<KV<Prefix, DEMFile>> makePageFileMapping (Pipeline p, String region, String series) {
	  ...
	  if (region.equals(global)) {
		  ...
		  regionPoly = makePolygon(gf, regionCoords);
	  }
	  ...
	  for (DEMFile dem : index.dems) {
		  ...
		  try {
			  include = region.equals(global) || regionPoly.intersects(wkt.read(dem.bound));
  ...
  public static class TopoPipeline implements Serializable {
	  ...
	  public TopoPipeline(String args[]) {
		  this(args, new DEMContext());
	  }
	  
	  public TopoPipeline(String args[], DEMContext demCtx) {
